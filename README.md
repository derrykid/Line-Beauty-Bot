## what this bot does:
This Line bot goes to Ptt beauty and get the post that receives most likes. It works on schedule.
...
## Line Bot config
You can find the config file at `src/main/resources/application.yml`. Please use your own channel-token and channel-secret
